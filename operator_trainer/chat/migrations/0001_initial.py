# Generated by Django 5.2.2 on 2025-06-10 17:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hints', models.TextField(blank=True, help_text='Через запятую, например: Подсказка 1, Подсказка 2', verbose_name='Подсказки')),
                ('client_responses', models.TextField(blank=True, help_text='Через запятую, например: Ответ 1, Ответ 2. Если пусто, будут использованы стандартные ответы.', verbose_name='Варианты ответов клиента')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
