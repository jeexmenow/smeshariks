...
SCENARIOS = [
    ...
    {
        "title": "Тестовый клиент: не работает прокси",
        "client_name": "Никита Волков",
        "client_status": "online",
        "difficulty": "medium",
        "situation": "Клиент купил прокси, но сайт не открывается и он считает, что доступ не работает.",
        "goal": "Спокойно уточнить тип прокси, проверить авторизацию и предложить понятные шаги проверки.",
        "initial_message": "Здравствуйте. Купил прокси, но ничего не открывается. Похоже, они вообще не работают.",
        "hints": "Уточните тип прокси и способ авторизации.\nНе спорьте с клиентом, сначала признайте проблему.\nПредложите проверить IP/логин/пароль или авторизацию по IP.",
        "knowledge_base_url": "https://df11ef6.platrum.ru/wiki/space/dlya-operatorov",
        "stop_words": "спасибо,понял,проверю",
        "steps": [
            {
                "step_number": 1,
                "client_message": "Прокси резидентские, подключаюсь по логину и паролю. Ошибка просто таймаут.",
                "expected_operator_response": "Признать проблему и уточнить тип прокси, авторизацию, ошибку.",
                "keywords": "здравствуйте,уточните,тип,авторизац,ошиб",
                "evaluation_criteria": "Эмпатия\nУточнение данных\nБез обвинения клиента",
                "hint": "Сначала уточните, как клиент подключается и какую ошибку видит.",
            },
            {
                "step_number": 2,
                "client_message": "IP в белый список не добавлял, думал логина и пароля достаточно.",
                "expected_operator_response": "Объяснить варианты авторизации и предложить проверить настройки.",
                "keywords": "логин,пароль,ip,авторизац,провер",
                "evaluation_criteria": "Пояснение\nИнструкция\nСледующий шаг",
                "hint": "Коротко объясните разницу авторизации по IP и по логину/паролю.",
            },
            {
                "step_number": 3,
                "client_message": "Понял, сейчас проверю настройки. Спасибо.",
                "expected_operator_response": "Завершить диалог и предложить вернуться, если не заработает.",
                "keywords": "проверьте,если,помогу,обращайтесь",
                "evaluation_criteria": "Завершение\nГотовность помочь",
                "is_final": True,
            },
        ],
    },
